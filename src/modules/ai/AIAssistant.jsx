...
- For cross-column filtering, groupby, precise counts by category, correlations, or any question that needs row-level analysis: write a \`\`\`python code block
...
- If the question IS answerable from the column stats below (e.g. overall value counts, numeric ranges): answer directly without code
